...
export const INITIAL_CHIMNEY_COMPONENTS_DATA: ChimneyComponentsData = {
    ...
    'STAL_RP_8': { id: 'STAL_RP_8', name: 'Rura stalowa prosta ø80mm (1m)', price: 50.00 },
    'STAL_KOLANO_8': { id: 'STAL_KOLANO_8', name: 'Kolano stalowe 90° ø80mm', price: 40.00 },
    'STAL_WYCZYSTKA_8': { id: 'STAL_WYCZYSTKA_8', name: 'Wyczystka (rewizja) stalowa ø80mm', price: 60.00 },
    'STAL_REDUKCJA_8_6': { id: 'STAL_REDUKCJA_8_6', name: 'Redukcja stalowa ø80/ø60mm', price: 35.00 },
    'STAL_ZAKONCZENIE_8': { id: 'STAL_ZAKONCZENIE_8', name: 'Zakończenie komina stalowego ø80mm', price: 70.00 },
    
    'IZO_RP_8': { id: 'IZO_RP_8', name: 'Rura izostatyczna prosta ø80mm', price: 80.00 },
    'IZO_RP_10': { id: 'IZO_RP_10', name: 'Rura izostatyczna prosta ø100mm', price: 90.00 },
    'IZO_RP_12': { id: 'IZO_RP_12', name: 'Rura izostatyczna prosta ø120mm', price: 100.00 },
    'IZO_RP_14': { id: 'IZO_RP_14', name: 'Rura izostatyczna prosta ø140mm', price: 110.00 },
    'IZO_PODLACZENIE_8': { id: 'IZO_PODLACZENIE_8', name: 'Trójnik izostatyczny ø80mm', price: 150.00 },
    'IZO_PODLACZENIE_10': { id: 'IZO_PODLACZENIE_10', name: 'Trójnik izostatyczny ø100mm', price: 160.00 },
    'IZO_PODLACZENIE_12': { id: 'IZO_PODLACZENIE_12', name: 'Trójnik izostatyczny ø120mm', price: 170.00 },
    'IZO_PODLACZENIE_14': { id: 'IZO_PODLACZENIE_14', name: 'Trójnik izostatyczny ø140mm', price: 180.00 },
    'IZO_WYCZYSTKA_8': { id: 'IZO_WYCZYSTKA_8', name: 'Wyczystka izostatyczna ø80mm', price: 120.00 },
    'IZO_WYCZYSTKA_10': { id: 'IZO_WYCZYSTKA_10', name: 'Wyczystka izostatyczna ø100mm', price: 130.00 },
    'IZO_WYCZYSTKA_12': { id: 'IZO_WYCZYSTKA_12', name: 'Wyczystka izostatyczna ø120mm', price: 140.00 },
    'IZO_WYCZYSTKA_14': { id: 'IZO_WYCZYSTKA_14', name: 'Wyczystka izostatyczna ø140mm', price: 150.00 },

    'PK_DUO_STAL': { id: 'PK_DUO_STAL', name: 'Pustak Duo Stal (h=33cm)', price: 75.00 },
    'PK_DUO_STAL_25': { id: 'PK_DUO_STAL_25', name: 'Pustak Duo Stal (h=24,5cm)', price: 70.00 },
    'PK_DUO': { id: 'PK_DUO', name: 'Pustak Duo Ceramika/Izo (h=33cm)', price: 80.00 },
};
